...
(defun qiang-set-font (english-fonts
  ...
  (save-excursion
    (with-current-buffer (find-file-noselect "~/.emacs.d/font-size")
  ...
  (setq face-font-rescale-alist `(("Microsoft Yahei" . ,chinese-fonts-scale)
                                  ...
                                  ("Droid Sans Fallback" . ,chinese-fonts-scale)
                                  ("文泉驿等宽微米黑" . ,chinese-fonts-scale)
                                  ("黑体" . ,chinese-fonts-scale)
                                  ("新宋体" . ,chinese-fonts-scale)
...
If set/leave chinese-font-size to nil, it will follow english-font-size"
  ...
  (let ((en-font (qiang-make-font-string
    ...
    (set-face-font 'italic (font-spec :family "Droid Sans Mono" :slant 'italic :weight 'normal :size (+ 0.0 english-font-size)))
    (set-face-font 'bold-italic (font-spec :family "Droid Sans Mono" :slant 'italic :weight 'bold :size (+ 0.0 english-font-size)))

    (set-fontset-font t 'symbol (font-spec :family "Droid Sans Mono"))
...
(defvar bhj-chinese-fonts '("STHeiti" "Droid Sans Fallback" "文泉驿等宽微米黑" "Microsoft Yahei" "Microsoft_Yahei" "微软雅黑" "黑体" "新宋体" "宋体"))
...
(global-set-key (kbd "C-M--") (lambda () (interactive) (bhj-step-frame-font-size -1)))
(global-set-key (kbd "C-M-=") (lambda () (interactive) (bhj-step-frame-font-size 1)))
